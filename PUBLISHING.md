# Publishing Guide: James's Claude Code Plugin
...
- [ ] Repository renamed to `jamesscalescode` ✅
...
2. Fill in the details:
   - **Repository name**: `jamesscalescode`
...
```bash
cd ~/Documents/GitHub/jamesscalescode

# Add the GitHub remote
git remote add origin https://github.com/jamesscalescode/jamesscalescode.git
...
/plugin install jamesscalescode/jamesscalescode
...
```bash
/plugin uninstall jamesscalescode
```

## Step 3: Share Your Plugin

Your README already includes your GitHub username `jamesscalescode`, so users can copy-paste commands directly!
...
```json
{
  "name": "jamesscalescode",
  "source": "jamesscalescode/jamesscalescode",
...
GitHub: https://github.com/jamesscalescode/jamesscalescode
```
...
1. Go to your repo: https://github.com/jamesscalescode/jamesscalescode
...
```bash
/plugin install jamesscalescode/jamesscalescode@v1.0.0
```
